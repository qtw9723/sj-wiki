---
title: "What's new"
source: "https://code.claude.com/docs/en/whats-new/index"
author:
published:
created: 2026-06-09
description: "A weekly digest of notable Claude Code features, with code snippets, demos, and context on why they matter."
tags:
  - "clippings"
---
The weekly dev digest highlights the features most likely to change how you work. Each entry includes runnable code, a short demo, and a link to the full docs. For every bug fix and minor improvement, see the [changelog](https://code.claude.com/docs/en/changelog).Week 22
...
[Read the Week 22 digest →](https://code.claude.com/docs/en/whats-new/2026-w22)Week 21
...
[Read the Week 21 digest →](https://code.claude.com/docs/en/whats-new/2026-w21)Week 20
...
[Read the Week 20 digest →](https://code.claude.com/docs/en/whats-new/2026-w20)Week 19
...
[Read the Week 19 digest →](https://code.claude.com/docs/en/whats-new/2026-w19)Week 18
...
[Read the Week 18 digest →](https://code.claude.com/docs/en/whats-new/2026-w18)Week 17
...
[Read the Week 17 digest →](https://code.claude.com/docs/en/whats-new/2026-w17)Week 16
...
[Read the Week 16 digest →](https://code.claude.com/docs/en/whats-new/2026-w16)Week 15
...
[Read the Week 15 digest →](https://code.claude.com/docs/en/whats-new/2026-w15)Week 14
...
[Read the Week 14 digest →](https://code.claude.com/docs/en/whats-new/2026-w14)Week 13
