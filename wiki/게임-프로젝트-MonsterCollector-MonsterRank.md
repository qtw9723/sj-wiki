...
> [!tip] 핵심 takeaway
> "몬스터 수집/랭크"라는 이름은 [[내-프로필]]의 **출발점 — 취미로 만들던 Unity 게임**의 연장선으로 보인다.
> 업무용 자동화/챗봇 라인([[프로젝트-포트폴리오]])과 달리 **놀이·실험 영역**. 커리어용은 아니지만, 새 기술을 부담 없이 시험하는 샌드박스로 가치가 있다.
...
- 문서: 없음 (CLAUDE.md·README·package.json 모두 없음). 정보 매우 제한적.

## 추정 & 메모
- 이름·쌍으로 보아 "수집(Collector) ↔ 랭킹(Rank)"의 연관 게임/콘텐츠일 가능성.
- 현 시점 메타데이터만 있어 단정 불가. **raw에 코드·기획을 넣어주면** 이 페이지를 채우고 [[공통-기술스택]] 사용 여부도 확인하겠다.
