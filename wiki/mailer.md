...
source: "사내 git 저장소 (live), 사용자 확인 2026-06-10 / 저장소 재확인 2026-06-25 · 2026-07-02"
status: 진행중
flagship: true
created: 2026-06-09
updated: 2026-08-05
...
- [[AI-주간-소식-2026-W32]] — 🆕 ⭐ **MIT: 비전문가는 틀린 AI 보조도 따른다**(위 설계 제약의 출처, 연결점 ⑭) · 지에스엔씨 아이즈레인(*수신 메일 자체가 AI 생성 피싱*일 수 있다는 미개척 기능 영역) · Beyond Byzantine(부서 간 정보 비대칭을 모델링 대상으로) · 다우오피스 AI(사내 데이터 기반 업무 자동화 = 같은 포지션의 SaaS 경쟁자)
