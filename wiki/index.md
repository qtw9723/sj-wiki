...
### 프로젝트 (팀숲)
- [[팀숲-bible-forest]] — 교회 대학부 신약 1독 챌린지 웹앱. Next.js 16 + Supabase. 6/23 시연 목표. 테마 3종(숲·바다·밤하늘) 요소 획득(가중치 랜덤)·랭크/이펙트·배치(취소 가능)·팀 랭킹.

### 회의록
- [[교회-개발-회의-2026-06-17]] — 2차 회의: 나무 회수 허용·권 단위 bulk replace·z_index·닉네임 10자·6/23 시연 목표 확정 (이후 6/22 디스코드에서 배치취소 허용 추가 확정 → [[팀숲-bible-forest]])
