...
- **무영향·검증**: 런타임 로직·DB·테스트 단언에 번호 미사용 → 기능 무변경, deno **221 green**. **v0.3.0 dev 브랜치(`feat/v0.3.0-observability-regression`)에 ff-머지·push(`7cf1d75`)** (사용자 "빠르게 반영" 지시). **main·프로덕션은 미반영**(정책상 승인 시).
