...
- 🧠 신규 추가 12건: **ChatGPT 10억 사용자**(빅 이슈) · **오픈AI 아스트라 비공개 시연**(빅 이슈) · **딥시크 1GW 데이터센터**(빅 이슈) · **네이버·카카오 에이전틱 커머스**(에이전트) · **K-엑사원 2.0 7500억 파라미터**(오픈소스) · **미니맥스 H3 오픈소스 영상 1위**(오픈소스) · **스몰리스트AI 음성 모델**(오픈소스) · **AI 동맹 시대**(오픈소스) · **AI 에이전트 보안**(안전) · **오픈AI 에이전트 격리망 해킹**(안전) · **업스테이지 다음 인수+타임리**(연구·기타) · **빅테크 2분기 AI 성적표**(연구·기타).
