...
- 🆕 [[AI-주간-소식-2026-W39]] — 📄 (KR-W39-13) **Unity 공식 플러그인(Claude Code 29 스킬 / Codex 31 스킬)** — 🚨 플러그인4셸 이틀 뒤 · 🧠 규격 통합은 *지침 파일*까지이고 *스킬 패키지*는 벤더별이라는 정밀화
